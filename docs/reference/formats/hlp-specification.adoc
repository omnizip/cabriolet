---
layout: default
title: Windows Help File Format Specification
...
* **QuickHelp** - DOS-based format (0x4C 0x4E signature) - Already implemented
* **Windows Help** - Windows 3.x/4.x format (0x35F3 or 0x3F5F signature) - This spec
...
+
Complete WinHelp decompiler, C source code, comprehensive format knowledge

2. **Wine project:** Windows Help viewer implementation
+
Format parsing code, cross-platform reference

3. **Microsoft documentation:** (historical, limited availability)
+
WinHelp API documentation, Help compiler notes
