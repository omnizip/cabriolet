...
* <<chm-commands#,CHM Commands>>
* <<szdd-commands#,SZDD Commands>>
* <<kwaj-commands#,KWAJ Commands>>
* <<hlp-commands#,HLP Commands>>
* <<lit-commands#,LIT Commands>>
* <<oab-commands#,OAB Commands>>
...
Available Commands:
  CAB Format:
    list        List contents of CAB file
    extract     Extract files from CAB
    info        Show detailed CAB information
    test        Test CAB file integrity
    search      Find embedded CAB files
    create      Create new CAB archive
...
* <<cab-commands#,CAB Commands Reference>>
* <<../../guides/getting-started/quick-start#,Quick Start Guide>>
