...
* <<../../reference/cli/szdd-commands#,SZDD Commands Reference>>
* <<../../reference/api/szdd-api#,SZDD API Reference>>
* <<../compression/lzss-compression#,LZSS Compression>>
...
For detailed algorithm information, see <<../compression/lzss-compression#,LZSS Compression>>.
...
# Use QBasic format
cabriolet compress --format=qbasic file.bas file.ba_
----
...
cabriolet expand --salvage file.tx_ file.txt
----
...
* **Format**: See <<../compression/lzss-compression#,LZSS Compression>>

For complete format specifications, see <<../../reference/formats/szdd-specification#,SZDD Specification>>.

=== Next Steps

* Learn about <<../compression/lzss-compression#,LZSS compression algorithm>>
* Review <<../../reference/cli/szdd-commands#,complete SZDD command reference>>
* Study <<../../reference/api/szdd-api#,SZDD API documentation>>

=== Bibliography

* <<../../reference/cli/szdd-commands#,SZDD Commands Reference>>
* <<../../reference/api/szdd-api#,SZDD API Reference>>
* <<../../reference/formats/szdd-specification#,SZDD Format Specification>>
