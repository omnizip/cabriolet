...
* <<../../reference/cli/hlp-commands#,HLP Commands Reference>>
* <<../../reference/api/hlp-api#,HLP API Reference>>
...
cabriolet hlp-create help.hlp system.dat topic.dat
...
[source,bash]
----
cabriolet hlp-info help.hlp  # Shows version
----
...
For complete format specifications, see <<../../reference/formats/hlp-specification#,HLP Specification>>.

=== Next Steps

* Learn about <<../compression/lzss-compression#mode-mshelp,LZSS MODE_MSHELP compression>>
* Review <<../../reference/cli/hlp-commands#,complete HLP command reference>>
* Study <<../../reference/api/hlp-api#,HLP API documentation>>

=== Bibliography

* <<../../reference/cli/hlp-commands#,HLP Commands Reference>>
* <<../../reference/api/hlp-api#,HLP API Reference>>
* <<../../reference/formats/hlp-specification#,HLP Format Specification>>
