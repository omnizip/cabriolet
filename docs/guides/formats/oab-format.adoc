...
* <<../../reference/cli/oab-commands#,OAB Commands Reference>>
* <<../../reference/api/oab-api#,OAB API Reference>>
...
cabriolet oab-extract --verbose file.oab output.dat
----
...
For complete format specifications, see <<../../reference/formats/oab-specification#,OAB Specification>>.

=== Next Steps

* Learn about <<../compression/lzx-compression#,LZX compression algorithm>>
* Review <<../../reference/cli/oab-commands#,complete OAB command reference>>
* Study <<../../reference/api/oab-api#,OAB API documentation>>

=== Bibliography

* <<../../reference/cli/oab-commands#,OAB Commands Reference>>
* <<../../reference/api/oab-api#,OAB API Reference>>
* <<../../reference/formats/oab-specification#,OAB Format Specification>>
