...
* <<../../reference/cli/cab-commands,CAB CLI Commands>>
...
Each part references the next, enabling extraction across volumes. See <<../compression/index,Compression Algorithms Guide>> for details.
...
See <<../compression/index,Compression Algorithms Guide>> for details.

=== Next steps

* Learn about <<../compression/index,compression algorithms>> in detail
* Explore <<../advanced-usage/multi-part-cabinets,multi-part cabinets>>
* Review <<../basic-usage/extracting-files,extracting files>>
* Study <<../../reference/api/index,Ruby API>>

=== See also

* <<../formats/chm-format,CHM Format>>
* <<../formats/szdd-format,SZDD Format>>
* <<../formats/index,All Format Guides>>

=== Bibliography

* https://github.com/omnizip/cabriolet[Cabriolet on GitHub]
* https://www.cabextract.org.uk/[cabextract Homepage]
