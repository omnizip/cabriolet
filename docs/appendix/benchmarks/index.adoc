...
==== link:compression-benchmarks.html[Compression Algorithm Benchmarks]
...
==== link:format-benchmarks.html[Format-Specific Benchmarks]
...
==== link:platform-benchmarks.html[Platform and Ruby Version Benchmarks]
...
==== link:memory-benchmarks.html[Memory Usage Profiles]
