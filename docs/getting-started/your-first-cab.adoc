...
* <<../guides/compression/index,Compression Algorithms Guide>>
...
For detailed comparison, see <<../guides/formats/format-comparison,Format Comparison>>.
...
* Review <<../guides/advanced-usage/performance-tuning,performance tuning>>
