...
-------------------------------------------
0         0x0001  PREV_CABINET: Previous cabinet info present
1         0x0002  NEXT_CABINET: Next cabinet info present
2         0x0004  RESERVE_PRESENT: Reserve area present
-------------------------------------------
----
...
Offset  Size  Field              Description
--------------------------------------------------------------
0       4     coffCabStart       Offset of first CFDATA block
4       2     cCFData            Number of CFDATA blocks
6       2     typeCompress       Compression type
--------------------------------------------------------------
----
...
-------------------------------------------
0x0000  NONE       No compression
0x0001  MSZIP      MSZIP compression
0x0002  QUANTUM    Quantum compression
0x0003  LZX        LZX compression
-------------------------------------------
----
...
Offset  Size  Field              Description
--------------------------------------------------------------
0       4     cbFile             Uncompressed file size
4       4     uoffFolderStart    Uncompressed offset in folder
8       2     iFolder            Folder index (or special value)
10      2     date               MS-DOS date
12      2     time               MS-DOS time
14      2     attribs            File attributes
16      ?     szName             Null-terminated filename
--------------------------------------------------------------
----
...
Value   Meaning
-------------------------------------------
0xFFFD  File continues from previous cabinet
0xFFFE  File continues to next cabinet
0xFFFF  File spans previous and next cabinets
-------------------------------------------
----
