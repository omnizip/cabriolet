...
Gem::Specification.new do |spec|
  ...
  spec.metadata["source_code_uri"] =
    "#{spec.homepage}/tree/main/examples/plugins/#{spec.name}"
  spec.metadata["changelog_uri"] =
    "#{spec.homepage}/blob/main/examples/plugins/#{spec.name}/CHANGELOG.md"
  spec.metadata["documentation_uri"] =
    "#{spec.homepage}/blob/main/examples/plugins/#{spec.name}/README.md"
